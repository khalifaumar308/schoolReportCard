...
import { data, assessment } from "./data";
...
const MyDocument = () => {
  ...
  const styles = StyleSheet.create({
    page: { padding: "4px", fontFamily: "Courier", fontStyle: "none" },
  ...
  const ass = assessment.map(({ assessment, rating }, id) => {
    return (
      <View
        key={id}
  ...
  <Document title="Motfield Montessoei">
    <Page size="A4" style={styles.page}>
      <View style={{ position: "relative" }}>
        ...
        >
          <Text>End of the year Assessment: Montessori III Class</Text>
        </View>
        <View
          style={{
            width: "100%",
        ...
        >
          <Text>
            <Text style={{ fontWeight: "black" }}>Name:</Text> ALLI ZANGO
            ABUBAKAR
          </Text>
          <Text>
            Teacher: <Text>Ms. Samiru</Text>
          </Text>
          <Text>Date: 29/07/20</Text>
          <Text>Attendance: 12</Text>
          <Text>(Absent: 23 days)</Text>
        </View>
      </View>
